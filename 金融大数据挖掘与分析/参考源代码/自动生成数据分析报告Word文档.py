...
def report():
    ...
    for company in companys:
        ...
        sql = 'SELECT * FROM article WHERE company = %s AND date = %s'  # 编写SQL语句
        ...
        introduction = '本次舆情监控目标为'+company+'，主要爬取网站为百度新闻，共爬取当天新闻' + str(num) + '篇，具体新闻如下：'
